...
<head>
    ...
    <link rel="shortcut icon" href="${request.static_url('dashboard:static/pyramid-16x16.png')}">
    ...
    <link href="${request.static_url('dashboard:static/theme.css')}" rel="stylesheet">
...
<div class="starter-template">
    <div class="container">
        <div class="row">
            <div class="col-md-2">
                <img class="logo img-responsive" src="${request.static_url('dashboard:static/pyramid.png')}"
