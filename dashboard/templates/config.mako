...
##     <link rel="icon" href="../../../../favicon.ico">
    ...
    <link href="${request.static_url("dashboard:static/css/form-validation.css")}" rel="stylesheet">
  </head>
  ...
  <body class="bg-light">
    ...
    <script src="${request.static_url("dashboard:static/js/holder.min.js")}"></script>
    <script>
